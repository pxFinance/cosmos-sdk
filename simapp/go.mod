...
require (
	...
	github.com/pxFinance/metrics/v2 v2.0.0// indirect
...
replace (
	// Simapp always use the latest version of the api (we actually forgot to do this when we did the original EIP712_V2)
	...
	github.com/pxFinance/metrics/v2 => ../metrics
